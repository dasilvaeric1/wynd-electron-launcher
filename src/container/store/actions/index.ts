...
// Stocke la réponse d'une requête WPT de diagnostic (ex. réponse à
// 'fastprinter.defaultprinterdata'), indexée par nom d'event.
...
export function setScreensAction(
  screens: IScreen[]
): IAppAction<TAppActionTypeKeys> {
  return {
...
export function openPinpadAction(
...
export function wptConnectAction(
  connect: boolean
): IAppAction<TAppActionTypeKeys> {
  return {
...
export function wptPluginsStateAction(
  state: TWPTPluginState
): IAppAction<TAppActionTypeKeys> {
  return {
...
export function wptPluginsStateUpdateAction(
  event: string,
...
export function iFrameReadyAction(
  ready: boolean
): IAppAction<TAppActionTypeKeys> {
  return {
...
export function iFrameDisplayAction(
  display: TFrameDisplay
): IAppAction<TAppActionTypeKeys> {
  return {
