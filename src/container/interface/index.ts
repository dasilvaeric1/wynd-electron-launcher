...
// Réponses brutes des requêtes WPT de diagnostic, indexées par nom d'event
// (ex. 'fastprinter.defaultprinterdata', 'universalterminal.plugin'). Le
// dashboard "Périphériques" lit ce slice. lastUpdate = timestamp ms du dernier
// reload.
