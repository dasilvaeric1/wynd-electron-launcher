  ...
  this.ajv.addKeyword({
    ...
    validate: function validate(metaData, data, parentSchema, it) {
        ...
        validate.errors = [
          {
            ...
            err: new CustomError(
              400,
              CustomError.CODE.MISSING_MANDATORY_PARAMETER,
              message,
              ["url"],
            ),
          },
      ...
      try {
        ...
        let remotePath = path.isAbsolute(data)
          ? data
          : path.join(confPath, data);
        ...
        for (let i = 0; i < metaData.length; i++) {
          ...
          if (it.rootData[key] === undefined) {
            ...
            errors.push({
              ...
              err: new CustomError(
                400,
                CustomError.CODE.MISSING_PARAMETER,
                message,
              ),
            });
      ...
      validate.errors = [
        {
          ...
          err: new CustomError(
            400,
            CustomError.CODE.INVALID_FORMAT_PARAMETER,
            message,
          ),
        },
      ];
  ...
  properties: {
    ...
    log: {
      ...
      properties: {
        ...
        // Persistance fichier locale des logs SCO/POS (logs/app/).
        // Off par défaut si absent. Remplace le logserver HTTP NW.js.
        persist_app: {
          allOf: [
            {
              coerce_boolean: true,
        ...
        // Capture des erreurs JS non catchées du POS en webview.
        // Off par défaut si absent.
        capture_errors: {
          allOf: [
            {
              coerce_boolean: true,
        ...
        // Capture des console.error / console.warn du POS en webview.
        // Off par défaut si absent.
        capture_console: {
          allOf: [
            {
        ...
        // Capture des requêtes réseau en échec du POS (via net_capture/CDP).
        // Off par défaut si absent.
        capture_network: {
          allOf: [
            {
